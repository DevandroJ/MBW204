...
class DetailPesananTransactionWarungPage extends StatefulWidget {
  final String idTrx;
  final String typeUser;
  final String status;

  DetailPesananTransactionWarungPage(
      {Key key,
      @required this.idTrx,
      ...
      : super(key: key);
  @override
  _DetailPesananTransactionWarungPageState createState() =>
      _DetailPesananTransactionWarungPageState();
}

class _DetailPesananTransactionWarungPageState
    extends State<DetailPesananTransactionWarungPage> {
  ...
  _getRequests() async {
    ...
    await warungVM.getTransactionPaidSingle(context, widget.idTrx, widget.typeUser).then((value) {
      setState(() {
        isLoading = false;
                                  ...
                                  Expanded(
                                    child: GestureDetector(
                                      onTap: () async {
                                        pr.show();
                                        await warungVM
                                            .postOrderDone(context, widget.idTrx)
                                            .then((value) {
                                          if (value.code == 0) {
                                            pr.hide();
                                            Fluttertoast.showToast(
          ...
          children: <Widget>[
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    "Terima kasih telah berbelanja di Warung Umart, Uang akan diteruskan ke Penjual",
                          ...
                          child: GestureDetector(
                            onTap: () {
                              Navigator.push(context,
                                ...
                                return PesananTransactionWarungPage(index: 5);
                              }));

...
class FancyBottomNavBar extends StatefulWidget {
  FancyBottomNavBar({@required this.tabs,
                            ...
                            child: Padding(
                              ...
                              child: AnimatedOpacity(
                                ...
                                child: Padding(
                                  ...
                                  child: widget.tabs[currentSelected].title == "Inbox" ? 
                                  Consumer<InboxProvider>(
                                    builder: (BuildContext context, InboxProvider inboxProvider, Widget child) =>
                                      inboxProvider.readCount == 0 
                                    ? Image.asset(
                                        activeImage,
                                        color: activeIconColor,
                                      )
                                    : Badge(
                                        position: BadgePosition.topEnd(top: -6.0, end: 24.0),
                                        animationDuration: Duration(milliseconds: 300),
                                        animationType: BadgeAnimationType.slide,
                                        badgeContent: Text(inboxProvider.inboxStatus == InboxStatus.loading 
                                        ? "..." 
            ...
            child: AnimatedAlign(
              ...
              child: AnimatedOpacity(
                ...
                ? Consumer<InboxProvider>(
                    ...
                    : Badge(
                        position: BadgePosition.topEnd(top: 0.0, end: 30.0),
                        animationDuration: Duration(milliseconds: 300),
                        animationType: BadgeAnimationType.slide,
                        badgeContent: Text(

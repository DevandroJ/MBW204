...
class AppConstants {
  ...
  static const String BASE_URL_DISBURSEMENT_DENOM = 'https://pg-$SWITCH_TO.connexist.id/disbursement/pub/v1/disbursement/denom';
  static const String BASE_URL_ECOMMERCE_DELIVERY_TIMESLOTS = '$SWITCH_TO_BASE_URL/commerce-mercyw204/pub/v1/ninja/deliveryTimeSlots';
  static const String BASE_URL_DISBURSEMENT_BANK = 'https://pg-$SWITCH_TO.connexist.id/disbursement/pub/v1/disbursement/bank';
  static const String BASE_URL_DISBURSEMENT_EMONEY = 'https://pg-$SWITCH_TO.connexist.id/disbursement/pub/v1/disbursement/emoney';
  static const String BASE_URL_DISBURSEMENT = 'https://pg-$SWITCH_TO.connexist.id/disbursement/api/v1';
  static const String BASE_URL_IMG = 'http://feedapi.connexist.id/d/f';
  static const String BASE_URL_CHAT = 'https://apidev.cxid.xyz:7443/api/v1/chat';
  static const String BASE_URL_FEED = 'https://feedapi.connexist.id/api/v1';
  ...
  static const String BASE_URL_SOCKET_FEED = 'https://apidev.cxid.xyz:5091'; 
  static const String BASE_URL_ECOMMERCE = '$SWITCH_TO_BASE_URL/commerce-mercyw204/api/v1';
  static const String BASE_URL_PPOB = '$SWITCH_TO_BASE_URL/ppob/api/v1';
  static const String BASE_URL_VA = 'https://pg-$SWITCH_TO.connexist.id/payment/pub/v1/payment/channels';
  static const String BASE_URL_PAYMENT_BILLING = 'https://pg-$SWITCH_TO.connexist.id/payment/page/guidance';
  static const String BASE_URL_HELP_PAYMENT = 'https://pg-$SWITCH_TO.connexist.id/payment/help/howto';
  static const String BASE_URL_HELP_INBOX_PAYMENT = 'https://pg-$SWITCH_TO.connexist.id/payment/help/howto/trx';
  static const String BASE_URL_ECOMMERCE_PICKUP_TIMESLOTS = '$SWITCH_TO_BASE_URL/commerce-mercyw204/pub/v1/ninja/pickupTimeSlots';

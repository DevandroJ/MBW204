...
class ColorResources {
  ...
  static Color getBlueToWhite(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFFFFFFFF) : Color(0xFF64B5F6);
  }
   static Color getBlueGreyToBlack(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFF414345) : Color(0xFFECEFF1);
  }
  ...
  static Color getPrimaryToWhite(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xffFFFFFF) : Color(0xffAF162B) ;
  }
  static Color getPrimaryToBlack(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xff2E2E2E) : Color(0xffAF162B) ;
  }
  static Color getDimGrayToWhite(BuildContext context) {
    return  Provider.of<ThemeProvider>(context).darkTheme ? Color(0xffFFFFFF) : Color(0xff6D6D6D).withOpacity(0.8);
  }
  ...
  static Color getError(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFF4A000A) : Color(0xFFcc3300);
  }
  ...
  static Color getBgBlack(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xff000000) : Color(0xffAF162B);
  }
  ...
  static Color getChatIcon(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xffbebeb) : Color(0xFFD4D4D4);
  }

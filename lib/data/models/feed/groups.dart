import 'package:mbw204_club_ina/data/models/feed/feedcharset.dart';
import 'package:mbw204_club_ina/data/models/feed/feedlevel.dart';
...
import 'package:mbw204_club_ina/data/models/feed/feedtimezone.dart';
import 'package:mbw204_club_ina/data/models/feed/feedvisibletype.dart';
...
class GroupsModel {
  ...
  factory GroupsModel.fromJson(Map<String, dynamic> json) => GroupsModel(
    ...
    body: List<GroupsBody>.from(json["body"].map((x) => GroupsBody.fromJson(x))),
  );
}
...
class GroupsBody {
  ...
  factory GroupsBody.fromJson(Map<String, dynamic> json) => GroupsBody(
    ...
    commented: List<Commented>.from(json["commented"].map((x) => Commented.fromJson(x))),
  );
}
...
class GroupsContent {
  ...
  factory GroupsContent.fromJson(Map<String, dynamic> json) => GroupsContent(
    ...
    charset: json["charset"] == null ? null : charsetValues.map[json["charset"]],
    caption: json["caption"] == null ? null : json["caption"],
    medias: json["medias"] == null ? null : List<FeedMedia>.from(json["medias"].map((x) => FeedMedia.fromJson(x))),
  );
}

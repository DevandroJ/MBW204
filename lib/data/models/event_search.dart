class EventSearchModel {
  ...
  List<EventSearchData> body;
  int code;
  String message;

  factory EventSearchModel.fromJson(Map<String, dynamic> json) => EventSearchModel(
    body: json["body"] == null ? null : List<EventSearchData>.from(json["body"].map((x) => EventSearchData.fromJson(x))),
...
class EventSearchData {
  ...
  factory EventSearchData.fromJson(Map<String, dynamic> json) => EventSearchData(
    ...
    media: json["Media"] == null ? null : List<EventSearchMedia>.from(json["Media"].map((x) => EventSearchMedia.fromJson(x))),
  );
}
